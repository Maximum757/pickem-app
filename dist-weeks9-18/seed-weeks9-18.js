...
if (!serviceAccountPath) {
    console.error("Missing FIREBASE_SERVICE_ACCOUNT_PATH. Set it to the path of your downloaded " +
    ...
    for (const weekNum of Object.keys(WEEKS).map(Number)) {
        ...
        for (let i = 0; i < games.length; i++) {
            ...
            await db
                ...
                homeTeam: g.home,
                awayTeam: g.away,
                gameTime: g.kickoff ? firestore_1.Timestamp.fromDate(new Date(g.kickoff)) : null,
